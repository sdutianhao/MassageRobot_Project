...
# 仿真生成深度图时使用的真值
DEPTH_SYN_ROT_GT = np.array([0.1, 0.0, 0.0], dtype=np.float32)
DEPTH_SYN_TRANS_GT = np.array([0.0, 0.0, 0.5], dtype=np.float32)

# ================= Stage 1 Init =================
# 刚体对齐的初始猜测
STAGE1_INIT_ROT = np.array([0.0, 0.0, 0.0], dtype=np.float32)
